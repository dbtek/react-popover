...
var PopoverContent = function PopoverContent(props) {
  ...
  return _react2.default.createElement(
    ...
    showArrow && _react2.default.createElement('div', {
      style: _extends({}, PopoverArrowStyle, placementStyle.arrow, { left: left, top: top })
    }),
...
var Popover = function Popover(props) {
  if (_reactDom2.default.findDOMNode(props.container) && _reactDom2.default.findDOMNode(props.container).parentElement.parentElement !== document.body) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      PopoverContent,
      { showArrow: props.showArrow, innerStyle: props.style, style: props.containerStyle },
      props.children
    )
  );
};
